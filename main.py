...
def command_completer():
    book_commands = ['add-contact', 'change-contact', 'add-email', 'change-email', 'add-address', 'change-address',
                     'phone', 'all-contacts', 'delete-record', 'search-by-name', 'search-by-phone', 'search-by-email',
                     'remove-phone', 'add-birthday', 'show-birthday', 'birthdays']
    notebook_commands = ['add-note', 'add-tag', 'change-title', 'change-body', 'change-tag', 'remove-note',
                        'remove-body', 'remove-tag', 'all-notes']
